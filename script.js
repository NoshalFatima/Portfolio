...
function renderItems(category) {
  ...
  items.forEach(item => {
    const html = `
      <div class="rounded-lg overflow-hidden shadow-md h-[420px] lg:ml-10 lg:mr-6 m-2 hover:shadow-xl border-t-[32px] border-l-[32px] border-r-[32px] border-[#170C24] transition bg-white lg:w-[550px] w-full group cursor-pointer  relative">
