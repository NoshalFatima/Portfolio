...
function renderItems(category) {
  ...
  items.forEach(item => {
    const html = `
      <div class="rounded-lg items-center justify-center overflow-hidden shadow-md h-[420px] lg:ml-12 lg:mr-6  hover:shadow-xl border-t-[32px] border-l-[32px] border-r-[32px] border-[#170C24] transition bg-black lg:w-[440px] xl:w-[600px] w-full group cursor-pointer  relative">
